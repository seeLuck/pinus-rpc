...
function failureProcess(code, tracer, serverId, msg, opts) {
    ...
    var FAIL_MODE = constants_1.constants.FAIL_MODE;
    var method = failfast;
...
var failsafe = function (code, tracer, serverId, msg, opts, cb) {
    var self = this;
    var retryTimes = opts.retryTimes || constants_1.constants.DEFAULT_PARAM.FAILSAFE_RETRIES;
    var retryConnectTime = opts.retryConnectTime || constants_1.constants.DEFAULT_PARAM.FAILSAFE_CONNECT_TIME;
